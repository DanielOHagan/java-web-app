...
public enum ChatErrorType implements IErrorType {
    ...
    FAILED_TO_RETRIEVE_SESSION("Failed to retrieve Chat Session", false, ErrorSeverity.MAJOR),
    ...
    SESSION_DOES_NOT_EXIST("The request Chat Session does not exist", false, ErrorSeverity.MAJOR),
    SESSION_ID_NOT_NEGATIVE("Chat Session ID must not be negative", false, ErrorSeverity.MAJOR),
    SESSION_ID_NUMERIC_ONLY("Chat Session ID must be an integer", false, ErrorSeverity.MAJOR);
